...
var geoip2 = function() {
    function Lookup(e, t, o, n) {
        ...
        this.geolocation = o && o.hasOwnProperty("geolocation") ? o.geolocation : navigator.geolocation,
        this.type = n
    }
    var exports = {};
    ...
    return Lookup.prototype.fillInObject = function(e) {
        for (var t = "country" === this.type ? fillIns.country : fillIns.city, o = 0; o < t.length; o++)
            for (var n = t[o], r = e, s = 0; s < n.length; s += 2) {
                var i = n[s];
                r[i] || (r[i] = "Object" === n[s + 1] ? {} : []),
                r = r[i]
            }
        try {
        ...
        var e,
            t,
            o = this,
            n = "//geoip-js.maxmind.com/geoip/v2.1/" + this.type + "/me?",
            r = {
                referrer: location.protocol + "//" + location.hostname
            };
        if (!this.alreadyRan) {
            this.alreadyRan = 1,
            "Microsoft Internet Explorer" === navigator.appName && window.XDomainRequest && navigator.appVersion.indexOf("MSIE 1") === -1 ? (t = new XDomainRequest, n = window.location.protocol + n, t.onprogress = function() {}) : (t = new window.XMLHttpRequest, n = "https:" + n);
            for (e in r)
                r.hasOwnProperty(e) && r[e] && (n += e + "=" + encodeURIComponent(r[e]) + "&");
            n = n.substring(0, n.length - 1),
            t.open("GET", n, !0),
            t.onload = function() {
                if ("undefined" == typeof t.status || 200 === t.status)
                    o.returnSuccess(t.responseText);
                else {
                    var e,
                        n = t.hasOwnProperty("contentType") ? t.contentType : t.getResponseHeader("Content-Type");
                    if (/json/.test(n) && t.responseText.length)
                        try {
